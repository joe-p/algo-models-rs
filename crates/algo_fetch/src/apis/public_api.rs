...
pub async fn account_application_information(configuration: &configuration::Configuration, address: &str, application_id: i32, format: Option<&str>) -> Result<models::AccountApplicationInformation200Response, Error<AccountApplicationInformationError>> {
...
pub async fn account_asset_information(configuration: &configuration::Configuration, address: &str, asset_id: i32, format: Option<&str>) -> Result<models::AccountAssetInformation200Response, Error<AccountAssetInformationError>> {
    let local_var_configuration = configuration;
...
pub async fn account_assets_information(configuration: &configuration::Configuration, address: &str, limit: Option<i32>, next: Option<&str>) -> Result<models::AccountAssetsInformation200Response, Error<AccountAssetsInformationError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AccountAssetsInformationError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn account_information(configuration: &configuration::Configuration, address: &str, format: Option<&str>, exclude: Option<&str>) -> Result<models::Account, Error<AccountInformationError>> {
    let local_var_configuration = configuration;
...
pub async fn get_application_box_by_name(configuration: &configuration::Configuration, application_id: i32, name: &str) -> Result<models::Box, Error<GetApplicationBoxByNameError>> {
    let local_var_configuration = configuration;
...
pub async fn get_application_boxes(configuration: &configuration::Configuration, application_id: i32, max: Option<i32>) -> Result<models::GetApplicationBoxes200Response, Error<GetApplicationBoxesError>> {
    let local_var_configuration = configuration;
...
pub async fn get_application_by_id(configuration: &configuration::Configuration, application_id: i32) -> Result<models::Application, Error<GetApplicationByIdError>> {
    let local_var_configuration = configuration;
...
pub async fn get_asset_by_id(configuration: &configuration::Configuration, asset_id: i32) -> Result<models::Asset, Error<GetAssetByIdError>> {
    let local_var_configuration = configuration;
...
pub async fn get_block(configuration: &configuration::Configuration, round: i32, format: Option<&str>) -> Result<models::GetBlock200Response, Error<GetBlockError>> {
    let local_var_configuration = configuration;
...
pub async fn get_block_hash(configuration: &configuration::Configuration, round: i32) -> Result<models::GetBlockHash200Response, Error<GetBlockHashError>> {
    let local_var_configuration = configuration;
...
pub async fn get_block_logs(configuration: &configuration::Configuration, round: i32) -> Result<models::GetBlockLogs200Response, Error<GetBlockLogsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetBlockLogsError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn get_block_time_stamp_offset(configuration: &configuration::Configuration, ) -> Result<models::GetBlockTimeStampOffset200Response, Error<GetBlockTimeStampOffsetError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetBlockTimeStampOffsetError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn get_block_txids(configuration: &configuration::Configuration, round: i32) -> Result<models::GetBlockTxids200Response, Error<GetBlockTxidsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetBlockTxidsError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn get_ledger_state_delta_for_transaction_group(configuration: &configuration::Configuration, id: &str, format: Option<&str>) -> Result<serde_json::Value, Error<GetLedgerStateDeltaForTransactionGroupError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetLedgerStateDeltaForTransactionGroupError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn get_light_block_header_proof(configuration: &configuration::Configuration, round: i32) -> Result<models::LightBlockHeaderProof, Error<GetLightBlockHeaderProofError>> {
    let local_var_configuration = configuration;
...
pub async fn get_pending_transactions(configuration: &configuration::Configuration, max: Option<i32>, format: Option<&str>) -> Result<models::GetPendingTransactionsByAddress200Response, Error<GetPendingTransactionsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_pending_transactions_by_address(configuration: &configuration::Configuration, address: &str, max: Option<i32>, format: Option<&str>) -> Result<models::GetPendingTransactionsByAddress200Response, Error<GetPendingTransactionsByAddressError>> {
    let local_var_configuration = configuration;
...
pub async fn get_state_proof(configuration: &configuration::Configuration, round: i32) -> Result<models::StateProof, Error<GetStateProofError>> {
    let local_var_configuration = configuration;
...
pub async fn get_supply(configuration: &configuration::Configuration, ) -> Result<models::GetSupply200Response, Error<GetSupplyError>> {
    let local_var_configuration = configuration;
...
pub async fn get_sync_round(configuration: &configuration::Configuration, ) -> Result<models::GetSyncRound200Response, Error<GetSyncRoundError>> {
    let local_var_configuration = configuration;
...
pub async fn get_transaction_group_ledger_state_deltas_for_round(configuration: &configuration::Configuration, round: i32, format: Option<&str>) -> Result<models::GetTransactionGroupLedgerStateDeltasForRound200Response, Error<GetTransactionGroupLedgerStateDeltasForRoundError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetTransactionGroupLedgerStateDeltasForRoundError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn get_transaction_proof(configuration: &configuration::Configuration, round: i32, txid: &str, hashtype: Option<&str>, format: Option<&str>) -> Result<models::GetTransactionProof200Response, Error<GetTransactionProofError>> {
    let local_var_configuration = configuration;
...
pub async fn pending_transaction_information(configuration: &configuration::Configuration, txid: &str, format: Option<&str>) -> Result<models::PendingTransactionResponse, Error<PendingTransactionInformationError>> {
    let local_var_configuration = configuration;
...
pub async fn raw_transaction(configuration: &configuration::Configuration, rawtxn: std::path::PathBuf) -> Result<models::RawTransaction200Response, Error<RawTransactionError>> {
    let local_var_configuration = configuration;
...
pub async fn raw_transaction_async(configuration: &configuration::Configuration, rawtxn: std::path::PathBuf) -> Result<(), Error<RawTransactionAsyncError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<RawTransactionAsyncError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn set_block_time_stamp_offset(configuration: &configuration::Configuration, offset: i32) -> Result<(), Error<SetBlockTimeStampOffsetError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SetBlockTimeStampOffsetError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn simulate_transaction(configuration: &configuration::Configuration, request: models::SimulateRequest, format: Option<&str>) -> Result<models::SimulateTransaction200Response, Error<SimulateTransactionError>> {
    let local_var_configuration = configuration;
...
pub async fn teal_compile(configuration: &configuration::Configuration, source: std::path::PathBuf, sourcemap: Option<bool>) -> Result<models::TealCompile200Response, Error<TealCompileError>> {
    let local_var_configuration = configuration;
...
pub async fn teal_disassemble(configuration: &configuration::Configuration, source: String) -> Result<models::TealDisassemble200Response, Error<TealDisassembleError>> {
    let local_var_configuration = configuration;
...
pub async fn teal_dryrun(configuration: &configuration::Configuration, request: Option<models::DryrunRequest>) -> Result<models::TealDryrun200Response, Error<TealDryrunError>> {
    let local_var_configuration = configuration;
...
pub async fn transaction_params(configuration: &configuration::Configuration, ) -> Result<models::TransactionParams200Response, Error<TransactionParamsError>> {
    let local_var_configuration = configuration;
...
pub async fn wait_for_block(configuration: &configuration::Configuration, round: i32) -> Result<models::GetStatus200Response, Error<WaitForBlockError>> {
    let local_var_configuration = configuration;
