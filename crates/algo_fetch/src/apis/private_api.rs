...
pub async fn add_participation_key(configuration: &configuration::Configuration, participationkey: std::path::PathBuf) -> Result<models::AddParticipationKey200Response, Error<AddParticipationKeyError>> {
    let local_var_configuration = configuration;
...
pub async fn append_keys(configuration: &configuration::Configuration, participation_id: &str, keymap: std::path::PathBuf) -> Result<models::ParticipationKey, Error<AppendKeysError>> {
    let local_var_configuration = configuration;
...
pub async fn generate_participation_keys(configuration: &configuration::Configuration, address: &str, first: i32, last: i32, dilution: Option<i32>) -> Result<String, Error<GenerateParticipationKeysError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GenerateParticipationKeysError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn get_config(configuration: &configuration::Configuration, ) -> Result<String, Error<GetConfigError>> {
    let local_var_configuration = configuration;
...
pub async fn get_debug_settings_prof(configuration: &configuration::Configuration, ) -> Result<models::DebugSettingsProf, Error<GetDebugSettingsProfError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetDebugSettingsProfError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn get_participation_key_by_id(configuration: &configuration::Configuration, participation_id: &str) -> Result<models::ParticipationKey, Error<GetParticipationKeyByIdError>> {
    let local_var_configuration = configuration;
...
pub async fn get_participation_keys(configuration: &configuration::Configuration, ) -> Result<Vec<models::ParticipationKey>, Error<GetParticipationKeysError>> {
    let local_var_configuration = configuration;
...
pub async fn put_debug_settings_prof(configuration: &configuration::Configuration, ) -> Result<models::DebugSettingsProf, Error<PutDebugSettingsProfError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PutDebugSettingsProfError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
