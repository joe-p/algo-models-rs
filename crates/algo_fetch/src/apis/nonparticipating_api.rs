...
pub async fn abort_catchup(configuration: &configuration::Configuration, catchpoint: &str) -> Result<models::AbortCatchup200Response, Error<AbortCatchupError>> {
...
pub async fn start_catchup(configuration: &configuration::Configuration, catchpoint: &str, min: Option<i32>) -> Result<models::StartCatchup200Response, Error<StartCatchupError>> {
    let local_var_configuration = configuration;
